			...
			if (result !== null && typeof result === "object" && typeof result.then === "function") {
				...
				var thenable = { then: function(resolve, reject) {
					...
					thenableResult.then(function(returnValue2) {
						popActScope(prevActScopeDepth);
						if (actScopeDepth === 0) recursivelyFlushAsyncActWork(returnValue2, resolve, reject);
						else resolve(returnValue2);
					}, function(error2) {
						popActScope(prevActScopeDepth);
						reject(error2);
					});
...
*/
//#endregion
export { require_react as n, __commonJS as t };

//# sourceMappingURL=chunk-HYFFLJFY-ByrqQPlY.js.map